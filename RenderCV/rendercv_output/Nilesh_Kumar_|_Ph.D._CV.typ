...
#let name = "Nilesh Kumar | Ph.D."
#let locale-catalog-page-numbering-style = context { "Nilesh Kumar | Ph.D. - Page " + str(here().page()) + " of " + str(counter(page).final().first()) + "" }
...
#two-col-entry(
  left-content: [
    #link("https://example.com")[*Example Project*]
  ],
  right-content: [
    May 2024 – present
  ],
...
#two-col-entry(
  left-content: [
    #link("https://example.com")[*Teaching on Udemy*]
  ],
  right-content: [
    Fall 2023
  ],
...
#one-col-entry(
  content: [#[*Programming:*] Proficient with Python, C++, and Git; good understanding of Web, app development, and DevOps]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#[*Mathematics:*] Good understanding of differential equations, calculus, and linear algebra]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#[*Languages:*] English \(fluent, TOEFL: 118/120\), Turkish \(native\)]
)
...
#v(design-highlights-top-margin);Frodo Baggins, #[*_John Doe_*], Samwise Gamgee
...
#one-col-entry(
  content: [- There are 7 unique entry types in RenderCV: #[_BulletEntry_], #[_TextEntry_], #[_EducationEntry_], #[_ExperienceEntry_], #[_NormalEntry_], #[_PublicationEntry_], and #[_OneLineEntry_].],
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
